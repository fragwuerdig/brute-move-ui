...
const socialLinks: SocialLink[] = [
    { icon: <TwitterIcon />, href: 'https://twitter.com/brutemovechess', label: 'Twitter' },
    { icon: <TelegramIcon />, href: 'https://t.me/brutemove', label: 'Telegram' },
    // Add more social links here as needed:
    // { icon: <DiscordIcon />, href: 'https://discord.gg/brutemove', label: 'Discord' },
    // { icon: <GitHubIcon />, href: 'https://github.com/brutemove', label: 'GitHub' },
];
...
export { TwitterIcon, TelegramIcon, DiscordIcon, GitHubIcon };
